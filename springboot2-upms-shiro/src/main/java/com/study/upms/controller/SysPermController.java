...
import com.study.upms.constant.PermType;
import com.study.upms.dao.model.SysPerm;
import com.study.upms.dao.model.SysPermExample;
...
public class SysPermController {
    ...
    public Json listAllPermission() {
        ...
        List<SysPerm> list = permService.selectByExample(example);
        if (list.isEmpty()){
    ...
    public Json listButtonPermMapGroupByParent() {
        ...
        SysPermExample example = new SysPermExample();
        example.createCriteria().andPtypeEqualTo(PermType.BUTTON);
        List<SysPerm> buttonPermList = permService.selectByExample(example);
